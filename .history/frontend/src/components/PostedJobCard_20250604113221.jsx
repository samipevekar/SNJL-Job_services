...
const PostedJobCard = ({
  ...
  const handleSave = () => {
    ...
    if (phone && (phone.length < 10 || phone.length > 10)) {
      return Alert.alert('Error', 'Phone numner must be 10 digits');
    }
          ...
          editMode ? (
            <View style={styles.statusSelector}>
              ...
              <TouchableOpacity
                ...
                <Text
                  style={status === 'completed' && styles.selectedOptionText}>
                  Completed
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <Text
                  style={status === 'rejected' && styles.selectedOptionText}>
                  Rejected
                </Text>
              </TouchableOpacity>
            </View>
